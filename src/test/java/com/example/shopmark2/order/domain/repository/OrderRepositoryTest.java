package com.example.shopmark2.order.domain.repository;
...
import com.example.shopmark2.user.infrastructure.persistence.entity.UserRoleEntity;
...
@Import({JpaAuditConfig.class, CustomAuditAware.class, QuerydslConfig.class,
        com.example.shopmark2.order.infrastructure.persistence.repository.OrderRepositoryImpl.class,
        com.example.shopmark2.order.infrastructure.persistence.mapper.OrderMapper.class,
        com.example.shopmark2.payment.infrastructure.persistence.mapper.PaymentMapper.class})
