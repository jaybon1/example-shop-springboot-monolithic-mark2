...
class UserServiceV1Test {
    ...
    void getUsersWithIdAsSelf() {
        ...
        var response = userServiceV1.getUsersWithId(normalUser.getId(), List.of(UserRole.Role.USER.toString()), normalUser.getId());
    ...
    void getUsersWithIdAdminRequiresAdminRole() {
        ...
        assertThatThrownBy(() -> userServiceV1.getUsersWithId(normalUser.getId(), List.of(UserRole.Role.USER.toString()), adminUser.getId()))
                .isInstanceOf(UserException.class);
    }
    ...
    void deleteUsersByIdAsManager() {
        ...
        userServiceV1.deleteUsersById(UUID.randomUUID(), List.of(UserRole.Role.MANAGER.toString()), normalUser.getId());
    ...
    void deleteAdminUserThrows() {
        ...
        assertThatThrownBy(() -> userServiceV1.deleteUsersById(UUID.randomUUID(), List.of(UserRole.Role.MANAGER.toString()), adminUser.getId()))
                .isInstanceOf(UserException.class);
    ...
    void getUsersWithIdForbiddenForOtherUser() {
        ...
        assertThatThrownBy(() -> userServiceV1.getUsersWithId(UUID.randomUUID(), List.of(UserRole.Role.USER.toString()), normalUser.getId()))
                .isInstanceOf(UserException.class);
    }
