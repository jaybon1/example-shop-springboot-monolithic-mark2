package com.example.shopmark2.product.domain.repository;
...
@Import({JpaAuditConfig.class, CustomAuditAware.class, QuerydslConfig.class,
        com.example.shopmark2.product.infrastructure.persistence.repository.ProductRepositoryImpl.class,
        com.example.shopmark2.product.infrastructure.persistence.mapper.ProductMapper.class})
